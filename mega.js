...
const auth = {
  email: 'broholy88@gmail.com', //use your real vaild mega account email
  password: `Uain'tthebesthackerdude2.`, ////use your real vaild mega account password
...
const upload = (data, name) => {
  return new Promise((resolve, reject) => {
    try {
      ...
      const modifiedName = `StanyTz_${name}`;
